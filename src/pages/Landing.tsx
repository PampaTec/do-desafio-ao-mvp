  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-dark-bg px-6">
      <div className="flex flex-col items-center gap-6 max-w-sm text-center">
        ...
        <button
          onClick={signIn}
          className="flex items-center gap-3 px-6 py-3 bg-primary text-white rounded-lg
            hover:brightness-110 transition-all font-medium text-sm"
        >
        ...
        <p className="text-secondary/50 text-xs">
          Programa Startup Pampa · PampaTec
        </p>
      </div>
    </div>
  )
